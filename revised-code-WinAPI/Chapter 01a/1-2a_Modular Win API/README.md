...
2. **first version of modular Win API code.** *<----- this example*
...
The beginning modularization, the app initialization and message loop in WinMain are placed into separate functions.
