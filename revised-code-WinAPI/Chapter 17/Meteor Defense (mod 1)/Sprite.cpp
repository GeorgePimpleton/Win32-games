...
{
   int sXShrink = (m_rcPosition.left - m_rcPosition.right) / 12;
   int sYShrink = (m_rcPosition.top - m_rcPosition.bottom) / 12;

   CopyRect(&m_rcCollision, &m_rcPosition);
   InflateRect(&m_rcCollision, sXShrink, sYShrink);
}
