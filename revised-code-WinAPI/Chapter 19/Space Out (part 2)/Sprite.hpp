...
public:
   ...
   void    SetFrameDelay(LONG iFrameDelay)            { m_frameDelay = iFrameDelay; };
...
{
   int iXShrink = (m_position.left - m_position.right) / 12;
   int iYShrink = (m_position.top - m_position.bottom) / 12;
