...
public:
   void Draw(HDC hDC, int x, int y, BOOL trans = FALSE, COLORREF transColor = RGB(255, 0, 255)) const;
   void  DrawPart(HDC hDC, int x, int y, int xPart, int yPart, int wPart, int hPart, BOOL trans = FALSE,
