...
int WINAPI       wWinMain(_In_ HINSTANCE inst, _In_opt_ HINSTANCE prevInstance, _In_ PWSTR cmdLine, _In_ int cmdShow);
...
public:
   ...
   void               PlayMIDISong(PCWSTR MIDIFileName = TEXT(""), BOOL restart = TRUE);
   void               PauseMIDISong( );
...
inline void GameEngine::SetFrameRate(UINT iFrameRate) { m_frameDelay = 1000 / iFrameRate; }
