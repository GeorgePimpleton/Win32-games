...
7. **Changed the wide strings to PCWSTRs.** *<----- this example*

Is pass 7 the final version?  Probably, but maybe not.  Depends on later game code that is updated to use smart pointers.
