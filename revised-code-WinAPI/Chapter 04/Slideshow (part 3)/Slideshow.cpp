...
BOOL GameInitialize( HINSTANCE hInstance )
{
   g_pGame = new GameEngine( hInstance, TEXT( "Slideshow" ),
                             TEXT( "Slideshow 3: Drawing Graphical Images" ), IDI_SLIDESHOW, IDI_SLIDESHOW_SM );
   if ( g_pGame == NULL )
      return FALSE;
...
void GameStart( HWND hWindow )
{
   ...
   g_pSlides[1] = new Bitmap( hDC, TEXT( "Res/Image1.bmp" ) );
   g_pSlides[2] = new Bitmap( hDC, TEXT( "Res/Image2.bmp" ) );
   g_pSlides[3] = new Bitmap( hDC, TEXT( "Res/Image3.bmp" ) );
   g_pSlides[4] = new Bitmap( hDC, IDB_IMAGE4, g_hInstance );
   g_pSlides[5] = new Bitmap( hDC, IDB_IMAGE5, g_hInstance );
   g_pSlides[6] = new Bitmap( hDC, IDB_IMAGE6, g_hInstance );
