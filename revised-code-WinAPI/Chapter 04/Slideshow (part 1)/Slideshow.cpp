...
BOOL GameInitialize( HINSTANCE hInstance )
{
   g_pGame = new GameEngine( hInstance, TEXT( "Slideshow" ),
                             TEXT( "Slideshow 1: Drawing Graphical Images" ), IDI_SLIDESHOW, IDI_SLIDESHOW_SM );
   if ( g_pGame == NULL )
      return FALSE;
...
void GameStart( HWND hWindow )
{
   ...
   g_pSlides[1] = new Bitmap( hDC, TEXT( "Image1.bmp" ) );
   g_pSlides[2] = new Bitmap( hDC, TEXT( "Image2.bmp" ) );
   g_pSlides[3] = new Bitmap( hDC, TEXT( "Image3.bmp" ) );
