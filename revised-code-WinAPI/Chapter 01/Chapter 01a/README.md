...
Not so coincidentally these WinAPI code modular examples are similar to the code structuring that shows up in the game examples.  The idea of modularizing the code was not derived from the game code, though.  The game code uses a different approach.
